...
const profilePicDim = { small: { x: 80, y: 80 }, medium: { x: 180, y: 180 }, large: { x: 400, y: 400 } };
...
setTimeout(function () {
    ...
    fs.readdir(__dirname + "/static_content/profile_pics/", (err, files) => {
        ...
        files.forEach((file, index) => {
            ...
            var goalPath = __dirname + '/static_content/profile_pics/large/';
            var dim = profilePicDim.large;
